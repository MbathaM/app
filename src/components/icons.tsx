...
export const ExclamationTriangleIcon: React.FC<IconSvgProps> = ({
  size,
  height,
  width,
  ...props
  ...
  return (
    ...
    >
      ...
      <g id="Shopicon">
        <path
          d="M44.229,36.968L25.772,5.001c-0.357-0.619-1.018-1-1.732-1s-1.375,0.381-1.732,1L3.852,36.968
		c-0.356,0.619-0.356,1.381,0,2c0.357,0.619,1.018,1,1.732,1h36.912c0.715,0,1.375-0.381,1.732-1
		C44.585,38.349,44.585,37.587,44.229,36.968z M9.048,35.968L24.04,10.001l14.992,25.967H9.048z"
        />
        <rect
          height="13"
          transform="matrix(1 -0.0039 0.0039 1 -0.0877 0.0939)"
          width="4"
          x="21.998"
          y="16.001"
        />
        <path
          d="M24.023,31.124c-0.969,0-1.755,0.786-1.755,1.755c0,0.969,0.786,1.754,1.755,1.754s1.755-0.786,1.755-1.754
...
export const CircleChevronRightIcon: React.FC<IconSvgProps> = ({
  fill = "currentColor",
  filled,
  size,
  height,
...
export const BriefcaseIcon: React.FC<IconSvgProps> = ({
  fill = "currentColor",
  filled,
  size,
  height,
...
export const GraduationCapIcon: React.FC<IconSvgProps> = ({
  fill = "currentColor",
  filled,
  size,
  height,
